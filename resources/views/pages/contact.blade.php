                                ...
                                <div class="icon-box-content table-cell">
                                    ...
                                    <div class="icon-box-content">
                                        <p class="mb-1">Email us :
                                            <span class="color-a"> ceo.paylater@gmail.com</span>
                                        </p>
                                        <p class="mb-1">Phone.
                                        ...
                                        <div class="socials-a">
                                            <ul class="list-inline">
                                              <li class="list-inline-item">
                                                <a href="https://www.facebook.com/profile.php?id=100088529786389&mibextid=LQQJ4d
                                                ">
                                                  <i class="fa fa-facebook" aria-hidden="true"></i>
                                                </a>
                                              </li>
                                              <li class="list-inline-item">
                                                <a href="https://twitter.com/paylater_ghana?s=21&t=Vo8VdnrIsalLiuluXMbYNA
                                                ">
                                                  <i class="fa fa-twitter" aria-hidden="true"></i>
                                                </a>
                                              </li>
                                              <li class="list-inline-item">
                                                <a href="https://instagram.com/paylater_official?igshid=MWI4MTIyMDE=
                                                ">
