<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand text-brand" href="{{ route('index') }}"><img src="{{asset('img/lg.png')}}" width="60" height="60" alt="" srcset=""></a>
                ...
                <li class="nav-item ">
                    <div class="justify-content-end">
                        <a href="https://wa.me/0240994061" target="_blank">
                            <img src="{{ asset('img/watsapplogo.png') }}" width="40px" height="40px" alt=""
                                srcset="">
                        </a>
                    </div>
                </li>
